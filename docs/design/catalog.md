...
| Surface | Read | Write | Config-as-code | Status |
|---------|------|-------|----------------|--------|
| datalake | powerquery (GraphQL + REST), query, facet, timeseries, numeric, saved-queries list, dashboards (list, get), parsers (list, get), notebooks (list, get) | addEvents, uploadLogs, saved-queries delete, parsers create, parsers delete, notebooks create, notebooks update, notebooks delete | -- | built |
...
| inventory | list, export, filter-options (all types) | notes, action | -- | built |

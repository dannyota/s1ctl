...
| [cloud-onboarding](cloud-onboarding.md) | delete, get, list, onboard | Manage CNAPP cloud account onboarding |
...
| [datalake](datalake.md) | dashboards, facet, files, ingest, notebooks, numeric, parsers, powerquery, query, saved-queries, timeseries | Query Singularity Data Lake (SDL) |
...
| [filters](filters.md) | create, delete, list, pull, push, update | Manage saved endpoint filters |
...
| [identity](identity.md) | ack-exposures, config, connector, domains, features, onboard, skip-exposures, timezones | Manage Identity AD Service configuration, connectors, and ISPM |
...
| [settings](settings.md) | cancel-pending-emails, delete-recipient, get, list, overrides, sso-cert, test, update | Manage platform settings |
...
| [tag-rules](tag-rules.md) | create, delete, list, pull, push, test, update | Manage dynamic asset tag rules |
...
| [updates](updates.md) | deploy, get, list | Manage agent update packages |
| [upgrade-policies](upgrade-policies.md) | activate, create, deactivate, delete, get, list, packages, pull, push, update | Manage agent auto-upgrade policies |
